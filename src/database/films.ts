...
const films: Film[] = [
  ...
  },
  {
    ...
    actors: [{ personId: 1, img: `${persons[0].imgMin}`, name: `${persons[0].nameRu}`, role: 'Барабант' }, { personId: 1, img: '', name: 'Чарльз Дэнс', role: 'Лорд Витинари' }, { personId: 1, img: '', name: 'Тэмсин Грег', role: 'Мисс Крипслок' }, { personId: 1, img: '', name: 'Ричард Койл', role: 'Мокрист фон Губвиг' }, { personId: 1, img: '', name: 'Адриан Шиллер', role: 'Мистер Грыль' }, { personId: 1, img: '', name: 'Дэвид Суше', role: 'Взяткер Позолот' }, { personId: 1, img: '', name: 'Терри Пратчетт', role: 'Почтальон' }, { personId: 1, img: '', name: 'Йен Бонар', role: 'Стэнли' }, { personId: 1, img: '', name: 'Клер Фой', role: 'Ангела Красота Добросерд' }],
    director: [{ personId: 1, img: '', name: 'Джон Джонс', role: 'Jon Jones' }],
    producers: [{ personId: 1, img: '', name: 'Род Браун', role: 'Rod Brown' }, { personId: 1, img: '', name: 'Вадим Жан', role: 'Vadim Jean' }, { personId: 1, img: '', name: 'Сью Де Бовуар', role: 'Sue De Beauvoir' }, { personId: 1, img: '', name: 'Сара Конрой', role: 'Sarah Conroy' }],
